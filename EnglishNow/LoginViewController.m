...
- (void)loginViewShowingLoggedInUser:(FBLoginView *)loginView {
    ...
    [self.navigationController pushViewController:((UIViewController *)appDelegate.slideViewController) animated:YES];
    //[self presentViewController:(UIViewController *)appDelegate.slideViewController animated:YES completion:nil];
}
